...
var shop = function () {
  ...
  var shopOptionPrompt = window.prompt(
    'Would you like to (r)efill your health, (u)pgrade your attack, or (l)eave the store? Please enter one "r", "u", or "l" to make a choice.'
  );

  // use switch case to carry out action
  switch (shopOptionPrompt.toLowerCase().charAt(0)) {
    case "r":
